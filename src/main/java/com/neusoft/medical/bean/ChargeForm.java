...
public class ChargeForm {
    ...
    public ChargeForm(Integer chargeFormId, Integer registrationId, Integer chargeItemId, Integer itemCount, Integer unchargedNums, Date madeTime, String reserve1, String reserve2, String reserve3, Integer departmentId, Integer doctorId, Integer collectorId, Integer notGivenNums) {
